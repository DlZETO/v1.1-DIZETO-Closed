...
export default function NavMode() {
  ...
  return (
    <i className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border-2 border-white/0 transition-all duration-250 dark:text-white" onClick={mode}>
