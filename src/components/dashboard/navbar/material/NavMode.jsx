...
export default function NavMode() {
  ...
  return (
    <div id="mode" className="h-9 w-9 cursor-pointer rounded-full border-2 border-white/0 transition-all duration-250 dark:text-white" onClick={mode}>
      <BsFillSunFill id="sun" className="mx-auto mt-2 block transition-all duration-500 dark:hidden" />
      <BsFillMoonFill id="sun" className="mx-auto mt-2 hidden transition-all duration-500 dark:block" />
    </div>
  );
}
